...
public class StackWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "io.github.nikkoes.katalogfilm.TOAST_ACTION";
    public static final String EXTRA_ITEM = "io.github.nikkoes.katalogfilm.EXTRA_ITEM";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(TOAST_ACTION)) {
            ...
            Toast.makeText(context, "Favorit ke" + viewIndex, Toast.LENGTH_SHORT).show();
        }
